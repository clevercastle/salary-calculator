...
export const SalaryResultTable = () => {
    ...
    data.push({
        key: "hpf",
        name: "住房公积金",
        user: NP.round(salaryResult.hpfUser, 2).toString(),
    ...
    data.push({
        key: "endowment",
        name: "养老保险",
        user: NP.round(salaryResult.endowmentUser, 2).toString(),
    ...
    data.push({
        key: "medical",
        name: "医疗保险",
        user: NP.round(salaryResult.medicalUser, 2).toString(),
    ...
    data.push({
        key: "unemployment",
        name: "失业保险",
        user: NP.round(salaryResult.unemploymentUser, 2).toString(),
    ...
    data.push({
        key: "maternity",
        name: "生育保险",
        user: NP.round(salaryResult.maternityUser, 2).toString(),
    ...
    data.push({
        key: "workInjury",
        name: "工伤保险",
        user: NP.round(salaryResult.workInjuryUser, 2).toString(),
    ...
    data.push({
        key: "sib-hpfb-all",
        name: "五险一金总支出",
        user: sibHpfAllUser.toString(),
        company: sibHpfAllCompany,
        all: NP.round(NP.plus(sibHpfAllUser, sibHpfAllCompany), 2),
    })

    data.push({
        key: "salary-minus-sib-hpfb",
        name: "扣除五险一金薪水",
        user: NP.round(salaryResult.salaryMinusSibHpfb, 2).toString(),
        company: null,
        all: null,
    })

    if (OneOffBonusType.single === salaryResult.oneOffBonusType) {
        data.push({
            key: "tax",
            name: "个人所得税",
            user: NP.round(salaryResult.tax, 2).toString(),
            company: null,
            all: null,
        })
    }

    if (OneOffBonusType.combine === salaryResult.oneOffBonusType) {
        data.push({
            key: "tax",
            name: "个人所得税",
            user: `${NP.round(NP.minus(salaryResult.tax, NP.divide(salaryResult.oneOffBonusTax, 12)), 2)}`,
            company: null,
            all: null,
        })
    }
    ...
    data.push({
        key: "salary",
        name: "税后月薪",
        user: NP.round(salaryResult.netSalary, 2).toString(),
        company: null,
        all: null,
    })
    data.push({
        key: "oneOffBonus",
        name: "全年一次性奖金",
        user: NP.round(NP.minus(salaryResult.oneOffBonus, salaryResult.oneOffBonusTax), 2).toString(),
        company: null,
        all: null,
    })
    ...
    data.push({
        key: "oneOffBonusTax",
        name: "全年一次性奖金税",
        user: NP.round(salaryResult.oneOffBonusTax, 2).toString(),
        company: null,
        all: null,
    })
    ...
    data.push({
        key: "yearIncome",
        name: "全年收入",
        user: NP.round(salaryResult.yearAllIncoming, 2).toString(),
        company: null,
        all: null,
    })
